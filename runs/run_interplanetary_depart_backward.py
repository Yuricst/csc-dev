...
def run_optim_depart(seq_key, algo, t0range=None, pop_size=10, n_t0=100, vinf_launch_max=4.5):
    ...
    # ]
    tof = [
        [-5/pk.DAY2YEAR, -1/pk.DAY2YEAR],
        [-7/pk.DAY2YEAR, -1/pk.DAY2YEAR],
    ]
...
if __name__=="__main__":
    ...
    t0range = [
        '2043-12-24 00:00:00.000',
        '2044-07-01 00:00:00.000'
    ]
    print(f"Using arrival window {t0range[0][0:10]} ~ {t0range[1][0:10]}")
    c3_max = 83
    ...
    filenames = os.listdir("../notebooks/optim_res_dep_c3_"+str(c3_max))+"_backward"
    n_data_already = 0
    ...
    if choose_save != "n":
        saved_file = "../notebooks/optim_res_dep_c3_"+str(c3_max)+"_backward"+"/seq_"+seq_name+"_"+str(n_data_already+1)
