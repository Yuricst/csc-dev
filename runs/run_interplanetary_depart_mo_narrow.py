...
def run_optim_depart(seq_key, algo, t0range=None, pop_size=10, n_t0=100, vinf_launch_max=4.5):
    ...
    for i_window in tqdm(range(n_t0), desc="scanning launch window"):
        ...
        prob_iter = pxp.get_depart_problem(seq, t0_iter, tof, vinf_launch_max, multi_objective=True)
...
if __name__=="__main__":
    ...
    if choose_save != "n":
        saved_file = "../notebooks/optim_res_dep_c3_"+str(c3_max)+"/moseq_"+seq_name+"_"+str(n_data_already+1)
